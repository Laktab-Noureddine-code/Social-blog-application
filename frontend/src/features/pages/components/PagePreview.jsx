...
import { formatPhoneNumber } from "@/shared/helpers/helper";
...
function PagePreview({
  ...
  return (
    <div className="w-full min-h-screen bg-[#f0f2f5] p-4 flex justify-center ">
      <div className="w-full max-w-[850px] min-h-[95vh] bg-white rounded-md shadow-2xl ">
        {/* Group banner */}
        {Pagecouverture ? (
          <img
        ...
        <div className="px-6 pt-4 pb-6">
          ...
          {/* À propos block, render only if at least one info exists */}
          {(description ||
            category ||
            email ||
            phone ||
            ...
            <div className="mt-6 border border-gray-200 rounded-lg p-4">
              ...
              {description && (
                <div className="mb-4 mt-2 max-w-full break-words whitespace-pre-wrap">
