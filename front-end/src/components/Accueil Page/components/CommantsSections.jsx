...
function CommentsSection({ postId, comments = [], toggleComments }) {
      ...
      <div className="bg-[#28242c] dark:bg-gray-50 w-full max-w-2xl mx-auto sm:px-0 py-5 max-h-[500px] rounded-md relative">
            ...
            {comments.map((comment, index) => (
              <div key={index} className="flex gap-2 mb-3">
                <Avatar className="w-8 h-8">
                  ...
                  <img src={`/images/img${Math.floor(Math.random() * 12) + 1}.jpg`} alt={comment.author} className="w-full h-full object-cover rounded-full"/>
                </Avatar>
        ...
        >
          <Avatar className="w-8 h-8">
            ...
            <img src={`/images/img${Math.floor(Math.random() * 12) + 1}.jpg`} alt="Your avatar" className="w-full h-full object-cover rounded-full"/>
          </Avatar>
          <div className="flex-1 flex">
            ...
            />
            <Button type="submit" variant="ghost" className="ml-2 p-2 text-white">
