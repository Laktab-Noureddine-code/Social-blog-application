    ...
    return (
        <div className="bg-white border rounded-lg overflow-hidden ">
            <div className="h-48 md:h-90 lg:h-100">
                <img src={groupCover(group.cover_image)} className="h-full w-full object-cover " alt="groupe cover Image" loading="lazy" />
            </div>
            <div className="px-4 pt-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex justify-between w-full items-center">
                            <div className="flex-1 -mt-2">
                                ...
                                <p className="text-gray-500">Groupe ({group.confidentiality}) • {getNumber(group.members)} members</p>
                            </div>
                            <div>
                ...
                <div className="flex gap-4 mt-4 border-t pt-4">
                    ...
                    <NavLink to={`/groups/${groupeId}`} className={({ isActive }) =>
                        `font-semibold cursor-pointer hover:bg-gray-50 px-4 py-2  
                        ${isActive && location === `/groups/${groupeId}` ? "border-blue-600 border-b-4 font-bold text-black" : "text-gray-600"}`}>
                        Discussion
                    </NavLink>
